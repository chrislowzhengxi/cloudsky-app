...
urlpatterns = [
    ...
    path('app/new', views.new_user, name='new_user_no_slash'),
    path('app/createUser/', views.create_user, name='create_user'),
    path('app/createUser', views.create_user, name='create_user_no_slash'),
    # HW5: New API endpoints
    path('app/createPost/', views.create_post, name='create_post'),
    path('app/createPost', views.create_post, name='create_post_no_slash'),
    path('app/createComment/', views.create_comment, name='create_comment'),
    path('app/createComment', views.create_comment, name='create_comment_no_slash'),
    path('app/hidePost/', views.hide_post, name='hide_post'),
    path('app/hidePost', views.hide_post, name='hide_post_no_slash'),
    path('app/hideComment/', views.hide_comment, name='hide_comment'),
    path('app/hideComment', views.hide_comment, name='hide_comment_no_slash'),
